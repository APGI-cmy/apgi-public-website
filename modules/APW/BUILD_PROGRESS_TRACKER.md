...
**Module Slug**: APW  
**Status**: Corrective Stage 6 QA-to-Red v0.2 drafted  
...
6. Stage 6 QA-to-Red v0.2 - active current wave on branch `apw-stage6-qa-to-red-v02`.
...
| 6 | `05-qa-to-red` | QA-to-Red | Corrective v0.2 drafted for review | Active branch `apw-stage6-qa-to-red-v02`; derives RED suite from Architecture v0.2A and canon checklist. |
...
| apw-stage6-qa-to-red-v02-20260604 | `apw-stage6-qa-to-red-v02` | Draft PR pending | Corrective Stage 6 QA-to-Red v0.2 drafted; ready for review after PR creation. |
...
Review and merge Corrective Stage 6 QA-to-Red v0.2. After acceptance, proceed to Corrective Stage 7 PBFAG v0.2.
